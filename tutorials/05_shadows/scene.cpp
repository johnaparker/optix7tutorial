...
namespace optix7tutorial {
  ...
  Scene::Scene() {
    ...
    launchParams.lightPos = make_float3(0,500,300);
  ...
  void Scene::createHitGroupPrograms() {
    hitgroupPGs.resize(2*RAY_TYPE_COUNT);
    ...
    OPTIX_CHECK(optixProgramGroupCreate(optixContext,
                                        ...
                                        &pgOptions,
                                        log,&sizeof_log,
                                        &hitgroupPGs[0+RAY_TYPE_RADIANCE]
                                        ));
    ...
    OPTIX_CHECK(optixProgramGroupCreate(optixContext,
                                        ...
                                        &pgOptions,
                                        log,&sizeof_log,
                                        &hitgroupPGs[0+RAY_TYPE_OCCLUSION]
                                        ));
    ...
    OPTIX_CHECK(optixProgramGroupCreate(optixContext,
                                        ...
                                        &pgOptions,
                                        log,&sizeof_log,
                                        &hitgroupPGs[2+RAY_TYPE_RADIANCE]
                                        ));
    ...
    OPTIX_CHECK(optixProgramGroupCreate(optixContext,
                                        ...
                                        &pgOptions,
                                        log,&sizeof_log,
                                        &hitgroupPGs[2+RAY_TYPE_OCCLUSION]
                                        ));
    }
  }
  ...
  void Scene::createSBT() {
    ...
    for (int rayID=0; rayID<RAY_TYPE_COUNT; rayID++) {
      ...
      OPTIX_CHECK(optixSbtRecordPackHeader(hitgroupPGs[0+rayID],&rec));
    ...
    for (int rayID=0; rayID<RAY_TYPE_COUNT; rayID++) {
      ...
      OPTIX_CHECK(optixSbtRecordPackHeader(hitgroupPGs[2+rayID],&rec));
      hitgroupRecords.push_back(rec);
    }
